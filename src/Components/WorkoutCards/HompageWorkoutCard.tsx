...
const HompageWorkoutCard = ({ eachWorkouts }: iworkOutCard) => {
    return (
        <div className='bg-[#15171D] border border-[#222630] rounded-2xl h-[500] cursor-pointer hover:border-[#C2F800]/50'>
            <div className='relative w-full aspect-video overflow-hidden rounded-t-2xl'>
                <Image src={eachWorkouts.image} alt='WorkOut Image' fill className='object-cover'></Image>
            </div>
